      ...
      <v-card flat tile class="black white--text py-12 px-5" width="100%">
        <v-row>
          ...
          <v-col cols="12" xs="12" sm="6" md="4">
            ...
            <v-card-text class="grey--text"> Ameya Raj </v-card-text>
            <v-card-text class="grey--text mt-n4">
              Patna Bihar
            </v-card-text>
            <v-card-text class="grey--text mt-n4"> ameya776rj.com </v-card-text>
            <v-card-text class="grey--text mt-n4"> 983793287 </v-card-text>
          </v-col>
        </v-row>
      </v-card>
    </v-footer>
